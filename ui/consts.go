...
// session list, preview/diff/terminal/inspector panes, tabbed window, menu bar,
// and error box. Components hold view state but defer domain actions to the app
// package's home model.
package ui
